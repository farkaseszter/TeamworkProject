...
format long
% --- User settings ---
filename_d = 'proppel_20_down_search_1800_1200_01.csv';
headerLines = 7;
rpm_d = zeros(1,12);
rpm_d(1,1) = 1800;
for rpm_var = 1:11
    rpm_d(1,rpm_var+1) = rpm_d(1,rpm_var)-50;
end
rpm_plot_d = [rpm_d;rpm_d];

ends_d = [35 60;85 115;135 165;180 205;220 250;260 290;300 330;
    340 370;385 410;425 450;465 490;500 530];
time_diff_d = 30;
...
for j1 = 1:3
    for j2 = 1:3
        for i = 1:length(ends_d(:,1))
            ...
            g_d(j1,j2,:,i) = median(time_segmented_d(i,:));
        end
...
filename_u = 'proppel_20_up_search_1200_1800_01.csv';
rpm_u = zeros(1,12);
rpm_u(1,1) = 1200;
for rpm_var = 1:11
    rpm_u(1,rpm_var+1) = rpm_u(1,rpm_var)+50;
end
rpm_plot_u = [rpm_u;rpm_u];

ends_u = [35 60;85 115;135 165;180 205;220 250;260 290;300 330;
    340 370;385 410;425 450;465 490;500 530];
time_diff_u = 30;
...
for j1 = 1:3
    for j2 = 1:3
        for i = 1:length(ends_u(:,1))
            ...
            g_u(j1,j2,:,i) = median(time_segmented_u(i,:));
        end
...
title(t5, 'Maximum displacement values vs rpm')
%% 
